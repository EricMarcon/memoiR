...
\Authors{
First Author's name\textsuperscript{1*}\par Second Author's name\textsuperscript{2}
} % Authors
\affiliation{
...
{\centering \includegraphics[width=0.8\linewidth]{/private/var/folders/2s/h6hvv9ps03xgz_krkkstvq_r0000gn/T/Rtmpg2o2f2/stylish_article/gallery/stylish_article/bookdown_pdf_book/stylish_article_files/figure-latex/pressure-1} 
