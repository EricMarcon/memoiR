...
\texttt{cover-image} is the name of an image file that will be used on the first page of the GitBook output.
Twitter shares use both to build a link to the project.
