...
Delete one of the two instructions in the header or both covers will be built, like in the gallery\footnote{\url{http://mirrors.ctan.org/macros/unicodetex/latex/polyglossia/polyglossia.pdf}}.
