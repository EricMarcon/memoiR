...
They can be called in the text, between brackets by the code \texttt{{[}@CitationKey{]}}, in parentheses \autocite{Xie2016}, or without square brackets, in the text, as \textcite{Xie2018} .
