...
```
:::{#pythkao .greybox data-latex='[frametitle=Pythagorean theorem]'
...
Enter it in a paragraph starting with `(ref:pythkao)` followed by a space. 
Then, call the text with the code `(ref:pythkao)`.
