...
A quick and complete training is offered by RStudio[^402].
...
They can be called in the text, between brackets by the code `[@Reference]`, or in the text, by removing the brackets.
...
Over a thousand styles are available [^41].
