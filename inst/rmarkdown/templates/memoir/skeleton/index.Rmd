...
fontsize: 11pt
# memoir Style
MemoirChapStyle: companion # or daleif1 with small margins
MemoirPageStyle: companion # or Ruled with small margins
# Margins
largemargins: false        # or false for small margins
smallmargin: 1.2in         # outer margin (small)
largemargin: 3in           # outermargin (large)
marginnote:  1.8in         # note width in large margin
spinemargin: 1.2in         # spine margin
...
biblatexoptions:
  - backend=biber
  - style=verbose-inote # or authoryear-ibid with small margins
  - pageref=true        # Comment out if citation style (e.g. authoryear-ibid) does not support it
  - isbn=false
  - backref=true
  - giveninits=true
  - uniquename=init
