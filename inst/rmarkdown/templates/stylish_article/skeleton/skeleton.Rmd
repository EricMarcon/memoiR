...
Name matches are listed in table 3 of the polyglossia package documentation[^1].

[^1]: http://mirrors.ctan.org/macros/unicodetex/latex/polyglossia/polyglossia.pdf
